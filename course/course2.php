...
*/
       // $result = mysqli_query($conn, "SELECT * FROM courses ca, learningtypes lt WHERE ca.learning_id = lt.learning_id LIMIT 8,8");

       $result = mysqli_query($conn, "SELECT course_name, photo, start_date, end_date, duration, start_at, end_at , learning_name  FROM subcategories sc, courses cs, learningtypes lt WHERE sc.course_id = cs.course_id and cs.learning_id = lt.learning_id and sc.subcategory_name = 'Level2' ");

       // $result = mysqli_query($conn, "SELECT * FROM subcategories sc, courses cs, learningtypes lt WHERE sc.course_id = cs.course_id and cs.learning_id = lt.learning_id and subcategory_name = 'Level2' ");
...
<video autoplay muted loop width="100%" height="500px">
  <source src="../yout2.mp4" type="video/mp4">
      ...
      <h2 align="center">Level Two Course</h2>
...
<img src="./photos/<?php echo $row['photo'] ?>" class="card-img-top"></td>          
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="course3.php">Next</a></li>  </ul>
</nav>
</div>

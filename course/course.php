...
<link rel="stylesheet" type="text/css" href="../stpyle.css">
...
*/
       // $result = mysqli_query($conn, "SELECT * FROM courses ca, learningtypes lt WHERE ca.learning_id = lt.learning_id LIMIT 8");

       $result = mysqli_query($conn, "SELECT course_name, photo, start_date, end_date, duration, start_at, end_at , learning_name FROM subcategories sc, courses cs, learningtypes lt WHERE sc.course_id = cs.course_id and cs.learning_id = lt.learning_id and sc.subcategory_name = 'Level1' ");

       // $result = mysqli_query($conn, "SELECT * FROM subcategories sc, courses cs, learningtypes lt WHERE sc.course_id = cs.course_id and cs.learning_id = lt.learning_id and subcategory_name = 'Level1' ");

       ?>

       <nav class="navbar navbar-expand-lg navbar-light bg-light  " id="navbar">
        <a class="navbar-brand" href="#"><img src="../e.png" style="width:130px; height:80px">
        </a>
        <h1 >YDP ACADEMY</h1>
        ...
        <div style="background-color:#9BD4F0;">
          ...
          <h1 align="center">Youth Development Programme</h1>

          <div class="col-lg-12 col-md-6 col-sm-6 my-5">
            <video autoplay muted loop width="100%" height="500px">
              <source src="../yout2.mp4" type="video/mp4">
              </video>
            </div>

          </div>
          <h2 align="center">Level One Course</h2>
              ...
              <?php while($row = mysqli_fetch_assoc($result)): ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 my-3">
                  <div class="card"value="<?php echo $row['course_id'] ?>" name="course_id">
                    <img src="./photos/<?php echo $row['photo'] ?>"class="card-img-top" >          
                    <div class="card-body">
                      ...
                      <h5 class="card-title" value="<?php echo $row['learning_id'] ?>">                
        ...
        <div class="container" >
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              <li class="page-item"><a class="page-link" href="course.php">Previous</a></li>
              <li class="page-item"><a class="page-link" href="course.php">1</a></li>
              <li class="page-item"><a class="page-link" href="course2.php">2</a></li>
              <li class="page-item"><a class="page-link" href="course3.php">3</a></li>
              <li class="page-item"><a class="page-link" href="course2.php">Next</a></li>  
            </ul>
            </nav>
          </div>

      ...
      <div class="container" align="center" style="padding-left: 100px">
        ...
        <div class="row" >
          <?php 
                          ...
                          $result = mysqli_query($conn, "SELECT * FROM activities ORDER BY activity_id DESC LIMIT 1"); 
...
<a href="
https://www.facebook.com/myantal.com.mm/posts/762303404504917"><button type="button" data-toggle="modal" data-target="#cardoneModal" class="btn btn-info">Read More</button> </a>
</div>
...
<div class="row" >
          <?php 
                          ...
                          $result = mysqli_query($conn, "SELECT * FROM activities ORDER BY activity_id DESC LIMIT 1,1"); 
          ...
          <div class="col-lg-6 col-md-6 col-sm-12"> 
            ...
            <p><?php echo $row['post'];?></p> 
            <a href="
https://www.facebook.com/yuta.martialarts/posts/1017144812059985"><button type="button" data-toggle="modal" data-target="#cardtwoModal" class="btn btn-info">Read More</button> </a>   
          </div>
          ...
          <?php 
                          ...
                          $result = mysqli_query($conn, "SELECT * FROM activities ORDER BY activity_id DESC LIMIT 2,1"); 
          ...
          <div class="col-lg-6 col-md-6 col-sm-12"> 
            <h3><?php echo $row['title'] ?></h3> <br><br>
           <p><?php echo $row['post'];?></p> 
           <a href="https://www.facebook.com/escmyanmar.institute/posts/775397216571571"><button type="button" data-toggle="modal" data-target="#cardthreeModal" class="btn btn-info">Read More</button></a> 
          </div>
